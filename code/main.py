...
import albumentations as  albumentation
...
def main():
    #Preprocess the data
    train_dataset = Preprocess_Dataset(dir_A=TRAIN_DIR+"/tatsuki", dir_B=TRAIN_DIR+"/photos", convertor=transforms_)
    test_dataset = Preprocess_Dataset(dir_A=TEST_DIR+"/tatsuki", dir_B=TEST_DIR+"/photos", convertor=transforms_)
